...
{
	$did=$_GET["did"];
	$update="update tbl_band set band_vstatus=2 where band_id='$did'";  
	mysql_query($update);
}
?>
...
<div class="container">
    <h3 class="text-center">Band Accepted</h3>
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        $selQry = "select * from tbl_band b inner join tbl_place p on p.place_id=b.place_id 
         inner join tbl_district d on p.district_id=d.district_id where b.band_vstatus=1";
        ...
        <tr>
          ...
          <td><img src="../Assets/Files/Band/Vimage/<?php echo $row["band_vimage"] ?>" width="150" height="150" /></td>
          <td><?php echo $row["category_id"] ?></td>
          <td><?php echo $row["district_name"] ?></td>
          <td><?php echo $row["place_name"] ?></td>
          <td><a href="BandAccept.php?did=<?php echo $row["band_id"] ?>" class="btn btn-danger">Reject</a></td>
        </tr>
        <?php
        }
        ?>
