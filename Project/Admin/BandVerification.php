...
{
	$did=$_GET["did"];
	$update="update tbl_band set band_vstatus=1 where band_id='$did'";  
	mysql_query($update);
}
if($_GET["did1"])
{
	$did1=$_GET["did1"];
	$update="update tbl_band set band_vstatus=2 where band_id='$did1'";  
	mysql_query($update);
}
...
<div class="container">
    <h3 class="text-center">Band Verification</h3>
    <table class="table table-bordered">
      ...
      <tbody>
        ...
        $selQry = "select * from tbl_band b inner join tbl_place p on p.place_id=b.place_id 
         inner join tbl_district d on p.district_id=d.district_id where b.band_vstatus=0";
        ...
        <tr>
          ...
          <td><a href="BandVerification.php?did=<?php echo $row["band_id"] ?>" class="btn btn-success">Accept</a></td>
          <td><a href="BandVerification.php?did1=<?php echo $row["band_id"] ?>" class="btn btn-danger">Reject</a></td>
        </tr>
        <?php
        }
        ?>
